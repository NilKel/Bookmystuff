    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(this)
                .enableAutoManage(this /* FragmentActivity */, connectionResult -> {
                    ...
                    Toast.makeText(LoginActivity2.this, "Network issues. Please check your connection or try again later.", Toast.LENGTH_SHORT).show();
                })
        ...
        mfirebaseAuth.addAuthStateListener(firebaseAuth -> {
            ...
            if (user != null) {
                // User is signed in
                runOnUiThread(() -> {
//                    mProgressView.setTitle("Logging in");
//                    mProgressView.show();
                });
...
//                        mProgressView.dismiss();
                ...
                Toast.makeText(LoginActivity2.this, "Please login to start", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void initializeUser(User mUser) {
        Intent intent = new Intent(LoginActivity2.this, OnboardingActivity.class);
        ...
        mfirebaseAuth.signInWithEmailAndPassword(username, password)
                .addOnCompleteListener(this, task -> {
                    ...
                    if (!task.isSuccessful()) {
                        ...
                        Toast.makeText(LoginActivity2.this, R.string.auth_failed,
        ...
        mfirebaseAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, task -> {
                    ...
                    if (!task.isSuccessful()) {
                        ...
                        Toast.makeText(LoginActivity2.this, "Authentication failed. Error: " + task.getException().getMessage(),
                                Toast.LENGTH_SHORT).show();
                    } else {
            ...
            switch (v.getId()) {
                ...
                case R.id.loginButton:
                    if (!username.getText().toString().isEmpty() && !password.getText().toString().isEmpty())
                        ...
                        Toast.makeText(LoginActivity2.this, "Please enter username and password", Toast.LENGTH_SHORT).show();
                    }
                    break;
